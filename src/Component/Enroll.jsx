...
export default function Enroll({ currentPlan }) {
  ...
  return (
    <div className="card card-pay">
      <div className="row d-flex align-items-center">
        ...
        <div className="col-lg-3 gft-svg">
          <div className="row">
            <div className="col-3">
              <svg
                width={28}
        ...
        <div className="col-lg-3 bdr-lr">
          <div className="card card-inner">
            <div className="row">
              <div className="col-3"></div>
              <div className="col-9">
                <p>Coupon code</p>
                <h1 className="fw-bold">AD1234</h1>
              </div>
            </div>
          </div>
        </div>
        <div className="col-lg-2 ps-4">
          ...
          <h1>${currentPlan?.price?.toLocaleString() ?? 0}</h1>
        </div>
        <div className="col-lg-2 px-lg-0">
          <button
            className="btn btn-warning w-100 rounded-pill"
            onClick={() => {
              navigate("/payment", { state: currentPlan });
            }}
          >
            Enroll now
          </button>
